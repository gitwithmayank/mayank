...
exports.registerViewJsonCommand = registerViewJsonCommand;
 ...
 */
function preprocessJsonString(jsonValue) {
 ...
 */
function getDetailedJsonErrorMessage(error, jsonValue, variableName) {
...
function registerViewJsonCommand(context) {
...
function createJsonViewer(jsonObj, extensionUri) {
    // Create and show panel
    const panel = vscode.window.createWebviewPanel('jsonViewer', 'JSON Viewer', vscode.ViewColumn.One, {
        enableScripts: true,
...
function webviewUri(webview, extensionUri, pathList) {
    return webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, ...pathList));
}
// Generate the HTML content for the webview
function getWebviewContent(jsonObj, webview, jsonEditorUri, jsonEditorCssUri) {
